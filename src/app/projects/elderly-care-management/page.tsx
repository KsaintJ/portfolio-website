...
export default function ElderlyCareManagementPage() {
  ...
  const screenshots = [
    ...
    {
      src: '/images/projects/elderly-care-management/caregiver-dashboard-patients.png',
      alt: 'Caregiver Dashboard - Patients',
      caption: 'Patient management view for care providers'
    },
    {
    ...
    {
      src: '/images/projects/elderly-care-management/caregiver-dashboard-medications.png',
      alt: 'Caregiver Dashboard - Medications',
      caption: 'Caregiver interface showing medication schedule and administration'
    },
    {
        ...
        <SafeMotion>
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-200 dark:border-gray-700">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              This full-stack project demonstrates capabilities that are valuable across a range of software development roles:
              </p>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
              <li>Building comprehensive full-stack applications - showing end-to-end development skills</li>
              <li>Creating role-based systems with different user interfaces - essential for complex enterprise applications</li>
              <li>Developing accessible and responsive UI for diverse users - demonstrates inclusive design thinking</li>
              <li>Implementing secure data handling for sensitive information - critical for healthcare and similar domains</li>
              <li>Solving real-world problems with technology - shows practical application of technical skills</li>
              <li>Applying client communication skills from my 10+ years of professional experience to user-centered design</li>
              </ul>
            </div>
          </motion.div>
        </SafeMotion>
