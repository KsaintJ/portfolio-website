        ...
        >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-200 dark:border-gray-700">
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
              ...
              <li>Using modern frontend technologies (React, Redux, Tailwind) - sought after in internship positions</li>
              <li>Working with design patterns and best practices that scale to larger applications</li>
              <li>Implementing advanced security features like MFA - demonstrates security awareness</li>
              <li>Creating data visualizations - shows ability to present complex information effectively</li>
            </ul>
          </div>
        </motion.div>
      </div>
