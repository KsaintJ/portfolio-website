        ...
        <SafeMotion>
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-200 dark:border-gray-700">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                This project showcases backend skills that are valuable for various development positions:
              </p>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
                <li>Designing and implementing RESTful APIs - a fundamental skill for backend roles</li>
                <li>Creating secure authentication and authorization systems - critical for data protection</li>
                <li>Working with databases and designing efficient schemas - essential for data-driven applications</li>
                <li>Implementing proper error handling and validation - necessary for robust production applications</li>
                <li>Testing and documenting APIs - demonstrates professional development practices</li>
                <li>Leveraging my information security background to build secure backend systems</li>
              </ul>
            </div>
          </motion.div>
        </SafeMotion>
